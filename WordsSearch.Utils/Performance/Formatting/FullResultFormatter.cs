...
namespace WordsSearch.Utils.Performance.Formatting
{
    ...
    /// </summary>
    public class FullResultFormatter : IResultFormatter
    {
        /// <summary>
        ...
        {
            return string.Format("{0}: {1}, {2} ms, {3} ticks", message, stopwatchElapsed, stopwatchElapsedMs, stopwatchElapsedTicks);
        }
    }
}